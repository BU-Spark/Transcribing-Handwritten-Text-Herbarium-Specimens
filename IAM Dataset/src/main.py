...
class FilePaths:
	...
	fnTrain = '../data/'
	#fnInfer = sys.argv[1] if sys.argv[1] else '../data/test.png'
...
def infer(model, fnImg):
	...
	gray = cv2.imread('out.png', cv2.IMREAD_GRAYSCALE)
...
def main():
	...
	parser.add_argument('--test_folder', default ='test.png', help='test image path')
	...
	# infer text on test image
		...
		if os.path.isfile(args.test_folder):
			infer(model,args.test_folder)
		else: 
			print('Test image not found,check image path and name')
